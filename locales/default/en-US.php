...
$locale = array( 
	...
	"INDEX_SUBTITLE1"=> "Find the event near you #United4Earth", 
	"INDEX_PASTEVENT"=> "Past events",
	"INDEX_CLP"=> "Citizen Lobbying Tool",
	...
	"INDEX_LANG_CHANGE_LINK"  => "https://united4earth.org/fr/marche-climat/",
	...
	"INDEX_HEADER2"=> "#RiseforClimate #United4Earth #ClimateAlarm #FridaysForFuture",
	"INDEX_EVENT1"=> "FridaysForFuture",
	"INDEX_EVENT2"=> "Climate Actions",
	"INDEX_EVENT3"=> "Plant Trees",
	"INDEX_EVENT4"=> "Petition",
	//"INDEX_EVENT5"=> "Friday For Future",
	"INDEX_GROUPS"=> "Facebook Group",
	"INDEX_OTHER"=> "Other",
	"INDEX_CANONICAL" => "https://united4earth.org/climate-map/",
	"INDEX_HREFLANG_CODE_FR" => "fdf_set_target_frame(fdf_document, frame_name)",  
  ...
  "404_MESSAGE" => "Error 404 : file not found",
  "404_BACKTOMAP" => "Back to map",
);
