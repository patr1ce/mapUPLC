...
var Event = (function($) { return function(properties) {
      ...
      this.render = function (distance, zipcode) {
	    ...
	    .append($(" : ").text(that.properties.start_day))
              ...
              $("<div class='social-area' />")
                ...
                .append(
                  $("<a class='rsvp-link'/>")
                    ...
                    .text(that.isFull ? "FULL" : that.properties.is_campaign_office ? (that.properties.opening_event ? "Lien vers le groupe" : "Group Link") : "Participer")
                )
                .append(
